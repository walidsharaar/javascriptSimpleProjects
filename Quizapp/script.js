...
function displayCurrentQuestion() {
    ...
    var questionClass = $(document).find(".mainContainer > .question");
    var choiceList = $(document).find(".mainContainer > .choiceList");
...
function displayScore() {
    $(document).find(".mainContainer > .result").text("You scored: " + correctAnswers + " out of: " + questions.length);
    $(document).find(".mainContainer > .result").show();
}
